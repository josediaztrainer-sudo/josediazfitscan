...
const Login = () => {
  ...
  const termsAccepted = acceptedTerms && isAdult;
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
      ...
      >
        ...
        {/* Terms & Age — ALWAYS visible (required for login AND signup) */}
        <div className="mb-4 space-y-3 rounded-lg border border-border/50 bg-card/60 p-3 backdrop-blur-sm">
          <p className="text-[11px] font-medium uppercase tracking-wider text-primary/80">Requisitos de acceso</p>
          <div className="flex items-start gap-3">
            <Checkbox
              ...
              className="mt-0.5"
            />
            <label htmlFor="terms-accept" className="text-xs leading-relaxed text-muted-foreground cursor-pointer">
          ...
          <div className="flex items-start gap-3">
            <Checkbox
              ...
              className="mt-0.5"
            />
            <label htmlFor="age-accept" className="text-xs leading-relaxed text-muted-foreground cursor-pointer">
        ...
        {!forgotMode && (
          <>
            ...
            <Button
              ...
              className="mb-4 w-full gap-3 border-border bg-card/80 py-5 font-medium text-foreground backdrop-blur-sm hover:bg-card disabled:opacity-40"
            >
        ...
        {forgotMode ? (
          ...
          <>
            <form onSubmit={handleAuth} className="space-y-4">
              ...
              <Button type="submit" disabled={loading || !termsAccepted} className="w-full font-display text-lg tracking-wider box-glow disabled:opacity-40">
