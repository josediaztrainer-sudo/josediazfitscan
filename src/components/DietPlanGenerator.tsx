...
import { Utensils, Loader2, ChevronDown, ChevronUp, Salad } from "lucide-react";
  ...
  return (
    <>
      <Button
        ...
        disabled={generating}
        className="mt-3 w-full gap-2 font-display tracking-wider"
        size="sm"
      >
        {generating ? (
          <>
      ...
      <Dialog open={showPlan} onOpenChange={setShowPlan}>
        <DialogContent className="max-h-[85vh] max-w-md overflow-y-auto">
          ...
          <Button
            ...
            variant="outline"
            className="mt-2 w-full font-display tracking-wider text-xs"
            size="sm"
          >
            🔄 REGENERAR DIETA
          </Button>
